...
<form name="userForm" method="post" action="/adduser.do" onSubmit="return userValidate();">
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="1" style="width:100%">
					...
					<tr>
						...
						<td>
<%--						<input name="birthday" type="text" class="input" id="birthday" value="2019-12-12">--%>
							<input type="text" id="test1" name="birthday" autocomplete="off">
							<script src="/laydate/laydate.js" charset="GBK"></script> <!-- 改成你的路径 -->
							<script>
								//执行一个laydate实例
								laydate.render({
									elem: '#test1' //指定元素
					...
					<tr>
						<td nowrap align="right">身份：</td>
						<td>
<%--						<input name="isadminhelp" type="checkbox" vonClick="javascript:adminChecked(); " >--%>
<%--						<input type="hidden"  name="isadmin" >--%>
						<input type="hidden"  name="createtime" value="<%=new Timestamp(System.currentTimeMillis())%>">
						<input name="isadmin" type="radio" value="0" checked> 普通用户
						<input name="isadmin" type="radio" value="1">管理员</td>
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<input name="content" type="text" class="input" id="content" value="">
